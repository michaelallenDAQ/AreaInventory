...
projected_temp_table <- project_baseline(base_table = temp_table, projection_table = projection_tables[["NonResNGMMCF_All State, UTAH"]])
#add controls
projected_temp_table <- add_controls(projected_temp_table)
#add to final_table and delete residual variables
final_table <- rbind(final_table, projected_temp_table)
rm(scc, efs_table, nonresNG, commercialNG, PtcommercialNG, AreacommercialNG, nonresNGDecatherm, temp_table, projected_temp_table)
