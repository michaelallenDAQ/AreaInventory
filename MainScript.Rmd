...
pp <- projection_tables[["Population"]]
AgJobs <- projection_tables[["AgJobs"]]
ManEmp <- projection_tables[["ManEmp"]]
...
temp_table <- pull_baseline_from_ww(scc = scc)
temp_table_project <- project_baseline(base_table = temp_table, projection_table = ManEmp)
# Apply controls
