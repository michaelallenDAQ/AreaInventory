...
#it is now focused on actual rocket testing/firing, like we would find at the ATK Promontory/Thiokol site (10009) or the ATK Bacchus plant (10402). We can eventually add inspection/maintenance of aircraft on airports, but that will be a more complex process.
scc <- 2810040000
...
# we came up with emissions calculations for this SCC by ourselves. Wheat, Corn, Hay, and Barley are like 99% of the
# PM10 that we get from harvesting in the state
scc <- 2801000005
