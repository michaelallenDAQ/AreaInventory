...
greater_than10TPY <- zz %>% filter(abs(tpy_change)>10)
large_changes <- greater_than10TPY %>% filter(abs(pct_change)>5)
#write out every difference larger than 10 TPY AND larger than 5%
