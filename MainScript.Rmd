...
#add to final_table
final_table <- rbind(final_table, projected_temp_table)
...
final_table <- rbind(final_table,temp_table_project)
...
#add to final_table and delete residual variables
final_table <- rbind(final_table, controlled_projected)
...
#no controls
final_table <- rbind(final_table, temp_table_subtracted)
...
final_table <- rbind(final_table,controlled_temp_table)
...
#####
#here we look at 2013 data. first compare the 2017 versions
back_2017 <- final_table %>% filter(year==2017)
#okay this matches perfectly
test <- compare_inventories(all_2017, back_2017, hide_pct = FALSE)
...
#####
#here we will compare my 2017 to the old 2017. first we need to filter them down to CAPs
...
#####
#here we will compare 2017 to 2023
