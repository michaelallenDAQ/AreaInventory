...
#this is supposed to globally set our working directory. Sometimes it doesn't work and you
#need to type in the console:
...
#merge with final_table, 
final_table <- rbind(final_table, projected_temp_table)
rm(scc, efefs_table, sewerFlow, ptSewer, areaSewer, temp_table, projected_temp_table)
...
rm(basement_pct, single_units, single_nobasement, single_basement, kcubic_yards, basement_dusts, basement_dirt, yesbasement, all_single_unit)
